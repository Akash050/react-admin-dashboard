...
const routes = [
  ...
  },
  {
    ...
    name: "Company",
    component: Company,
    role: ["ROLE_SUPER_ADMIN", "SUPER_ADMIN_AS_COMPANY_ADMIN"],
  },
  {
...

  {
    ...
    name: "Employees",
    component: Employees,
    role: ["ROLE_COMPANY_ADMIN", "ROLE_ADMIN", "SUPER_ADMIN_AS_COMPANY_ADMIN"],
  },
  {
  ...
  },
  {
    ...
    name: "Dashboard",
    component: Dashboard,
    role: ["ROLE_COMPANY_ADMIN", "SUPER_ADMIN_AS_COMPANY_ADMIN", "ROLE_ADMIN"],
  },
  {
    path: "/admin/contacts",
    name: "Contacts",
