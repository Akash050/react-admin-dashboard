                ...
                return (
                  <tbody key={val.id}>
                    <tr>
                      ...
                      <td>
                        {isTagDropdown ? <Autocomplete
                          options={tagsoptions}
                          onChange={(e, v) => handleTagChange(e, v, val)}
                          getIconLabel={(option) => option}
                          value={tagsoptions.find(v => v == val.contactType.type) || {}}
                          style={{ width: 200 }}
                          renderInput={(params) => (
                            <div
                              ref={params.InputProps.ref}
                              className="input-field-control-role"
                              className="monthly-salary2"
                            >
                              <input
                                style={{
                                  cursor: 'pointer',
                      ...
                      <td>
                        {val.connectionStatus ? (
                          <Autocomplete
                            ...
                            onChange={(e, v) => handleStatusChange(e, v, val)}
                            getIconLabel={(option) => option}
                            value={statusoptions.find(v => v == val.connectionStatus.connectionStatus) || {}}
                            style={{ width: 200 }}
                            renderInput={(params) => (
                              <div
                                ref={params.InputProps.ref}
                                className="input-field-control-role"
                                className={getClassName(val.connectionStatus.connectionStatus)}
                              >
                                <input
                                  style={{
                                    cursor: 'pointer',
                          ...
                          />
                            ...
                            <div className="monthly-salary none-color">
                              None
                            </div>
                          )}
                      ...
                      <td>
                        <span className="titlefill-tb choose_action">
                          ...
                          >
                            <i class="far fa-trash-alt" style={{ fontSize: '20px' }}></i>
                          </button> */}
                          <img
                            src={external_link}
