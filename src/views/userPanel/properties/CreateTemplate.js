...
const CreateProperty = () => {
  ...
  const [listItems, setListItems] = useState([
    { id: 1, name: "item #1", value: "", selected: true, val: "" },
  ...
  const onSubmit = async () => {
    ...
    if (data.success === true) {
      // setSelectedStep(0)
      setIsLoading(false)
      swal('Template Created Successfully', {
        icon: "success",
      });
      if (templateUrl != "") {
  ...
  console.log("event.target.files uniit  att-sss>", isAddCustom);
  return (
    <>
      ...
      {selectedStep == "0" ? (
        <div className="property-card border-0 card-heightbody">
          <div className="backproperty-button text-left">
            <CButton
              className="save-btn-white-header btn"
              style={{ width: "200px", padding: "0px !important" }}
              onClick={() => history.push("/user/properties")}
            >
              <img src={BackIcon} className="m-0 mr-2" /> Back To Properties
            </CButton>
          </div>
          <div className="bgwhite mx-0">
            <div className="row justify-content-center custom--add-tem_row">
              <div className="col-12 col-md-4 px-2">
                <div className="add_custom" onClick={() => setIsAddCustom(true)}>
                  <div className="mb-4">
                ...
                <div className="cardBox">
                  ...
                  <div className="create-employee-wrapper border px-0 py-3">
                    <div className="form-group col-12 mb-0 text-left">
                      ...
                      <div className="properttxt-wrp fmt-0">
                  ...
                  <div className="row">
                    <div className="col-12 col-md-5 px-2">
                      ...
                      Property Name
                        ...
                        <div className="create-employee-wrapper border px-0 py-3">
                          <div className="form-group col-12 mb-0">
                            <label className="textaprt-label">Cresccent Bay Apartments</label>
                          </div>
                        </div>
                      </div>
                      <div className="cardBox mb-3">
