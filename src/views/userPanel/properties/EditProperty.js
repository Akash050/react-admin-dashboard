...
const EditProperty = (props) => {
    ...
    const [propertyLabels, setPropertyLabels] = useState(
        data ? JSON.parse(data.propertyInformationJson) : []
    );
    ...
    const [financialLabels, setFinancialLabels] = useState(
        data ? JSON.parse(data.financialInformationJson) : []
    );
    const [unitLabels, setUnitLabels] = useState(
        data ? JSON.parse(data.unitInformationJson) : []
    );
    ...
    const [selectedContact, setSelectedContact] = useState(data.contact);
    ...
    // console.log(" Tableeee     -->", unitLabels);
    ...
    const handleEditNotesModal = (val) => {
        setIsAddNotesModal(true);
        setPropertyNotesId(val.id);
        setNotesTitle(val.title);
        setNotesDescription(val.description);
        onCalanderChange(val.date.toDate);
    };

    const deleteAttachment = async (id, type, check) => {
        console.log("id , type, check", id, type, check)
        if (check) {
            if (type == 'image') {
                swal({
                    title: "Are you sure?",
            ...
            if (type == 'image') {
                swal({
                    ...
                    .then(async (willDelete) => {
                        setIsLoading(true)
                        if (willDelete) {
                            const data = await dispatch(removeAttachment(id, type));
                            console.log("fdata ->", data)
                            console.log("fdata success ->", data.data.success)
                            if (data.data.success == true) {
                                let temp = await imagesPreviewList.filter((ele) => ele.id != id)
                                console.log("temp -0---?", temp)
                                setImagesPreviewList(temp)
                                setIsLoading(false)
                                swal("Deleted Successfully!", {
                ...
                swal({
                    ...
                    .then(async (willDelete) => {
                        ...
                        if (willDelete) {
                            ...
                            console.log("fdata success ->", data.data.success)
                            if (data.data.success == true) {
                                let temp = await attachmentList.filter((ele) => ele.id != id)
                                console.log("temp -0---?", temp)
                                setAttachmentList(temp)
                                setIsLoading(false)
                                swal("Deleted Successfully!", {
    ...
    // console.log(" at-sss selectedContact>", attachmentList);
    return (
        <>
                                                ...
                                                return (
                                                    <div className="properttxt-wrp">
                                                        <div className="propertyNote--area">
                                                            <div
                                                                class="text-right"
                                                                onClick={() => handleEditNotesModal(val)}
                                                            >
                                                                <img src={Dotline} />
                                                            </div>
                          ...
                          <img src={xml} className="" />
                                                ...
                                                {attachmentList.map((val) => {
                                                    ...
                                                    if (val.type != undefined) {
                                                                ...
                                                                <div className="properties---columnImg borderattach-0">
                                                                    ...
                                                                    <div className="template_action">
                                                                        <div class="boxwigit--baredit">
                                                                            ...
                                                                            <span onClick={() => deleteAttachment(val, 'attachment', 1)} className="icon-delt--tem">
                                                                                <i
                                                        ...
                                                        let tempType = val.fileUrl.split('.')
                                                                ...
                                                                <div className="properties---columnImg borderattach-0">
                                                                    ...
                                                                    <div className="template_action">
                                                                        <div class="boxwigit--baredit">
                                                                            ...
                                                                            <span onClick={() => deleteAttachment(val.id, 'attachment', 0)} className="icon-delt--tem">
                                                                                <i
                                                                                    class="fa fa-trash fa-2x"
                                                                                    aria-hidden="true"
                                                                                ></i>
                        ...
                        <div className="px-1 col-md-4 col-12">
                          <img src={ImageFile2} className="image_attachment" />
                                                ...
                                                {imagesPreviewList.map((url) => {
                                                    console.log("pr ur  l>", url.imageUrl)
                                                    if (url.imageUrl == undefined) {
                                                        return (
                                                                ...
                                                                <div className="properties---columnImg borderattach-0">
                                                                    ...
                                                                    <div className="template_action">
                                                                        <div class="boxwigit--baredit">
                                                                            ...
                                                                            <span
                                                                                onClick={() => deleteAttachment(url, 'image', 1)}
                                                                ...
                                                                <div className="properties---columnImg borderattach-0">
                                                                    ...
                                                                    <div className="template_action">
                                                                        <div class="boxwigit--baredit">
                                                                            ...
                                                                            <span
                                                                                onClick={() => deleteAttachment(url.id, 'image', 0)}
                                                                                className="icon-delt--tem">
                                                                                <i
                                                                                    class="fa fa-trash fa-2x"
                                                                                    aria-hidden="true"
                                ...
                                >
                                  <img className="m-0 ml-2" src={CrossItem} />
                                              ...
                                              :null} */}
                                                                            ...
                                                                            {/* <div className="popup-btn">
                                        <div onClick={(e) => addTableRow(val.tempId, 'unit')} className="btn-value btnadd-btn-custom-property add-table-btn px-2">
                                          <img src={addicon} className="m-0 mr-1" /> Add
                                        </div>
                                      </div> */}
                                                                            {/* <tr>
